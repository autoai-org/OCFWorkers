...
CUDA_VISIBLE_DEVICES=2 python hf_worker.py --model-name mosaicml/mpt-7b-chat --trust-remote-code --fast-tokenizer  --dtype bfloat16 &\
CUDA_VISIBLE_DEVICES=1 python hf_worker.py --model-name mosaicml/mpt-7b-chat --trust-remote-code --fast-tokenizer  --dtype bfloat16 &\
CUDA_VISIBLE_DEVICES=0 python hf_worker.py --model-name mosaicml/mpt-7b-chat --trust-remote-code --fast-tokenizer  --dtype bfloat16
